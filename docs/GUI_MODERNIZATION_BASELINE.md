...
**Status:** Automated profile redraw baseline, 20-second internal simulator live-sampling smoke baselines, and a 60-second internal simulator live-sampling baseline are captured; real-device baselines remain pending.
