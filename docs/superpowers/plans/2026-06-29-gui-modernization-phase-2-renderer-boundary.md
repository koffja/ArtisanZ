...
After this plan is complete, create a second Phase 2 plan for a Matplotlib snapshot extractor. That extractor should read from `tgraphcanvas` and produce `RoastPlotSnapshot` without changing `updategraphics()` behavior.
