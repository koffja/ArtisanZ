...
| 5 | Local QML Islands | Started: workspace-status model + lazy dock + screenshot validation | A limited Qt Quick panel or dashboard backed by Python state models | QML proves useful without breaking packaging, translations, or Windows portable build |
