...
| 4 | Main UI Information Architecture | Started: workspace model + `UI_MODE` mapping | Scenario-oriented Roast Control, QC Analysis, and Device Setup workspaces | Users can switch task modes without losing existing expert controls |
