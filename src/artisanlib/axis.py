...
#        self.xaxislencombobox.setMaximumWidth(120)
        ...
        self.ygridSpinBox.setMinimumWidth(90)
        self.ygridSpinBox.setMaximumWidth(104)
        ...
        self.zgridSpinBox.setMinimumWidth(90)
        self.zgridSpinBox.setMaximumWidth(104)
...
#        autoDeltaButton.clicked.connect(self.autoDeltaAxis)
        ...
        self.gridwidthSpinBox.setMinimumWidth(90)
        self.gridwidthSpinBox.setMaximumWidth(104)
        ...
        self.gridalphaSpinBox.setMinimumWidth(90)
        self.gridalphaSpinBox.setMaximumWidth(104)
